...
<head>
    ...
    <!-- Autres balises meta, liens CSS, etc. vont ici -->

    <!-- Inclure fichier JavaScript externe -->
    <script src="<?php echo get_template_directory_uri(); ?>/efffondu.js"></script>
...
<body <?php body_class(); ?>>
    ...
    <main id="primary" class="site-main">
        <section class="banner fade-in-section logo>
            <!-- Ajout de la classe " fade-in-section" -->
            <img src="<?php echo get_template_directory_uri() . '/assets/images/logo.png'; ?> "
                alt="logo Fleurs d'oranger & chats errants">
        </section>
        <section id="story" class="story fade-in-section animationdepartverslehaut">
            <!-- Ajout de la classe "fade-in-section" -->
            <h2>L'histoire</h2>
        ...
        ?>
            <article id="characters" class="fade-in-section animationdepartverslehaut">
                <!-- Ajout de la classe "fade-in-section" -->
            ...
            <article id="place" class="fade-in-section animationdepartverslehaut">
                <!-- Ajout de la classe "fade-in-section" -->
                <div>
                    <h3>Le Lieu</h3>
        ...
        <section id="studio" class="fade-in-section animationdepartverslehaut">
            <!-- Ajout de la classe "fade-in-section" -->
